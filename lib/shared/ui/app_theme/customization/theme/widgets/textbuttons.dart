...
class ResetRandomSaveButtons extends StatefulWidget {
  const ResetRandomSaveButtons({
    super.key,
    this.random,
    this.reset,
    this.resetAll,
  ...
  @override
  State<ResetRandomSaveButtons> createState() => _ResetRandomSaveButtonsState();
}

class _ResetRandomSaveButtonsState extends State<ResetRandomSaveButtons> {
  @override
