...
class AnimationQuickSettingsItem extends StatelessWidget {
  const AnimationQuickSettingsItem({super.key, required this.model});
  final AnimModels model;

  @override
  Widget build(BuildContext context) {
    CustomAnimationController _animController = Get.find(tag: model.keys[0]);
    return Obx(() {
      return Padding(
